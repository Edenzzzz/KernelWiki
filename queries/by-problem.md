...
| memory-bound, low-compute-utilization, high-memory-throughput | [Memory Bandwidth Bound](wiki/patterns/memory-bound.md) | technique-vectorized-loads, technique-swizzling, technique-swizzling | 3 sources |
